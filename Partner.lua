...
OrionLib:MakeNotification({
	Name = "PSX Partner & Mail Spoof",
	Content = "Good luck, follow the instructions in the UI.",
	Image = "rbxassetid://4483345998",
	Time = 5
})

local Window = OrionLib:MakeWindow({Name = "PSX Partner & Mail Spoof", HidePremium = false, SaveConfig = false, ConfigFolder = "KryptedSaves"})
...
If you have any questions, message ReturnString#0001
]])
